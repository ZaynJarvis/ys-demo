...
export default function AboutPage() {
    return (
        <div className="w-full bg-gray-800 min-h-screen flex flex-col items-center justify-center p-8 text-center text-white">
            <h1 className="text-4xl font-bold mb-16">About Us</h1>
            <div className="flex flex-wrap justify-center gap-4 max-w-12xl">
